...
class ManAttendance(models.Model):
    _name = "man.attendance"
    ...
    def _check_validity(self):
        ...
        for attendance in self:
            ...
            last_attendance_before_check_in = self.env['man.attendance'].search([
            ...
            if not attendance.check_out:
                ...
                no_check_out_attendances = self.env['man.attendance'].search([
                    ('employee_id', '=', attendance.employee_id.id),
                    ('check_out', '=', False),
                    ('id', '!=', attendance.id),
                ])
                ...
                last_attendance_before_check_out = self.env['man.attendance'].search([
                    ('employee_id', '=', attendance.employee_id.id),
