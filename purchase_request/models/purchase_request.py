          ...
          if rec.state == 'to_approve':
            ...
            for lvl in var:
              for lvl_chk in lvl.z_order_line_id:
                #pdb.set_trace()
                if rec.z_login_id.id == lvl_chk.z_purchase_request_approve.id:
...
class PurchaseRequestLine(models.Model):
  ...
  states = fields.Selection([('approval1','Approved'),('approval2','Confirmed'),('reject','Reject')])
        ...
        if rec.z_login_id:
          if rec.state == 'to_approve':
            ...
            for lvl in var:
              ...
              #     pdb.set_trace()
              if rec.z_login_id.id in approve1 and rec.z_login_id.id in approve2:
                self.states = 'approval2'
                s = True
                break
              else:
